...
1. Download `slop-scrubber-extension-v0.1.7.zip` from Releases.
2. Unzip it.
3. Open `chrome://extensions`.
4. Enable Developer Mode.
5. Click "Load unpacked" and select the unzipped `slop-scrubber-extension-v0.1.7/` folder.
...
This also writes `dist/releases/slop-scrubber-extension-v0.1.7.zip`, which is the file attached to GitHub Releases for less technical users.
